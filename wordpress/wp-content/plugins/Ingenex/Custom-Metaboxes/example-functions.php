...
// 	);
    ...
    $meta_boxes['conversion_tracking'] = array(
		'id'         => 'conversion_tracking',
		'title'      => __( 'Tracking Code Snippet', 'cmb' ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		...
		'fields'     => array(
			array(
				'name' => __( 'Conversion Tracking', 'cmb' ),
				'id'   => $prefix . 'code',
				'type' => 'textarea_code',
			),
...
function cmb_initialize_cmb_meta_boxes() {
	...
	if ( ! class_exists( 'cmb_Meta_Box' ) )
		 require_once( trailingslashit( IDM_PLUGIN_PATH ) . 'Custom-Metaboxes/init.php');
