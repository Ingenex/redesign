...
function edd_panorama_license_menu() {
	add_options_page( 'Project Panorama', 'Project Panorama', 'manage_options', 'panorama-license', 'edd_panorama_license_page' );
}
...
function edd_panorama_license_page() {
	...
	?>
	<div class="wrap">
		<h2><?php _e('Project Panorama License Options'); ?></h2>
				...
				<tbody>
					<tr valign="top">	
						...
						<td>
							...
							<label class="description" for="edd_panorama_license_key"><?php _e('Enter your license key'); ?></label>
						</td>
					</tr>
					<?php if( false !== $license ) { ?>
						<tr valign="top">	
							...
							<td>
								...
								<?php } else {
									wp_nonce_field( 'edd_panorama_nonce', 'edd_panorama_nonce' ); ?>
...
add_action('admin_init', 'edd_panorama_activate_license');
